...
public class EmployeeRowMapper implements RowMapper<Employee> {
  ...
  @Override
  public Employee mapRow(ResultSet row, int rowNum) throws SQLException,SQLIntegrityConstraintViolationException {
    // try {
...
//return row.getString(1);
   ...
   // department.setId(row.getLong("department_id"));
    ...
    //employee.setDepartment(Department.create(row.getLong()));
    return employee;
